                ...
                <div class="card card-primary">
                      ...
                      <div class="table-responsive p-0">
                        <table class="table  table-hover text-nowrap">
                            ...
                            <tbody>
                                @if (!empty($list))
                                    @foreach ($list as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="return confirm('Bạn có chắc chắn muốn xóa?')" href="{{route('drugs.delete',['id'=>$item->id])}}" class ="btn btn-danger btn-md">
                                ...
                                @else
                                      <tr>
                                        <td colspan="7">Không có thuốc</td>
                                      </tr>
                                @endif
                    ...
                    <div class="card-footer clearfix">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                            <a href="{{route('drugs.trash')}}" class="btn btn-outline-danger float-right">Recycle Bin</a>
                        </div>
                      </div>
                    </div>
