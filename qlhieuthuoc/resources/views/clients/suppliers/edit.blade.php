      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('suppliers.postEdit')}}" method="POST">
              <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                              name="supplier_name" required placeholder="Nhập tên nhà cung cấp..." value="{{old('supplier_name') ?? $detail->supplier_name}}">
                              @error('supplier_name')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control"
                              name="email"  required placeholder="Nhập số điện thoại..." value="{{old('email') ?? $detail->email}}">
                              @error('email')
                                  <span style="color: red">{{$message}}</span>
                              @enderror
                        </div>
