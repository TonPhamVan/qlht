...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2022 at 02:20 PM
...
(8, 'Hoàng Tùng', 'Nam', 'Bắc Ninh', 'ggggffffff', '2022-07-14 11:59:27', '2022-07-14 11:59:27', NULL),
...
(4, 6, 'Omega 36912', NULL, NULL, NULL, NULL, '100000', 'Hộp', '2022-07-14 12:04:35', NULL, '2022-07-14 12:04:35'),
(5, 3, 'sdfsdf', NULL, NULL, NULL, NULL, '222222', 'Hộp', '2022-07-14 12:04:59', NULL, '2022-07-14 12:04:59'),
(6, 5, 'dgfdg', NULL, NULL, NULL, NULL, '100000', 'Vỉ', '2022-07-14 12:04:33', NULL, '2022-07-14 12:04:33'),
(7, 5, 'xbc', NULL, NULL, NULL, NULL, '100000', 'Vỉ', '2022-07-14 12:04:30', NULL, '2022-07-14 12:04:30'),
(8, 5, 'dgfdgxcvfcx', NULL, NULL, NULL, NULL, '100000', 'Vỉ', '2022-07-14 12:04:19', NULL, '2022-07-14 12:04:19');
...
ALTER TABLE `import_bills`
  ADD PRIMARY KEY (`id`),
  ADD KEY `import_detail_id` (`import_detail_id`),
...
--
ALTER TABLE `drugs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'mã thuốc', AUTO_INCREMENT=9;
...
--
ALTER TABLE `import_bills`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'mã hóa đơn nhập';
...
--
ALTER TABLE `import_bills`
  ADD CONSTRAINT `import_bills_ibfk_1` FOREIGN KEY (`import_detail_id`) REFERENCES `import_details` (`id`),
  ADD CONSTRAINT `import_bills_ibfk_2` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`);
